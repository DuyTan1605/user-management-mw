...
#    + host config affected from jdk version: 7u171 8u102 9b103 openjdk7u
JVM_JMX_HOST=$SYS_IP_ADDR
JVM_JMX_PORT=
#remote debug: 63999 (leave it's empty to disable), format [ip:]port
JVM_JDWP_PORT=
...
JVM_HTTPS_PROXY_HOST=
JVM_HTTPS_PROXY_PORT=

JVM_SOCK_PROXY_HOST=zsproxy-1.zalo.services
JVM_SOCK_PROXY_PORT=8880
